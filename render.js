...
.vfoot{ margin-top:auto; border-top:2px solid var(--rule); padding-top:13px; font-size:15px;
...
function buildVisual(p, lang){
  ...
  function vfoot(i){
    return '<div class="vfoot"><span>'+e(L(lang,'disclaimer'))+'</span><span class="en"><b>'+i+' / 2</b></span></div>';
  }
